...
sankeyPlot$setLib('~/projects/development/expands/rCharts_d3_sankey-gh-pages/')
sankeyPlot$setTemplate(script = "~/projects/development/expands/rCharts_d3_sankey-gh-pages/layouts/chart.html")
